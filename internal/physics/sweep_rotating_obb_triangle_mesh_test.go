...
func TestSweepRotatingOrientedBoxTriangleMeshDetectsThinWallHit(t *testing.T) {
	...
	contact := physics.SweepRotatingOrientedBoxTriangleMesh(
		body,
	...
	if !contact.Hit {
		t.Fatalf("expected rotating OBB sweep to hit the triangle mesh wall")
	}
