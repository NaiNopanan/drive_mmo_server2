...
func (r *RaylibDebugRenderer) DrawWorld(world *world.World) {
	if r == nil || world == nil {
		return
	}
	...
	for _, id := range world.EntityIDs() {
		...
		case physics.ShapeTypePlane:
			r.drawPlane(body, renderComponent)
		case physics.ShapeTypeBox:
			r.drawBox(body, renderComponent)
		case physics.ShapeTypeSphere:
			r.drawSphere(body, renderComponent)
		}
	}
}

func (r *RaylibDebugRenderer) drawPlane(body physics.BodyComponent, renderComponent world.PrimitiveRenderComponent) {
...
func (r *RaylibDebugRenderer) drawBox(body physics.BodyComponent, renderComponent world.PrimitiveRenderComponent) {
...
func (r *RaylibDebugRenderer) drawSphere(body physics.BodyComponent, renderComponent world.PrimitiveRenderComponent) {
	fill := toRaylibColor(renderComponent.Color)
...
func toRaylibColor(color world.Color) rl.Color {
