...
func (w *World) SetName(id EntityID, component NameComponent) bool {
	if !w.HasEntity(id) {
		return false
	}
...
func (w *World) SetTransform(id EntityID, component TransformComponent) bool {
	if !w.HasEntity(id) {
		return false
	}
...
func (w *World) SetPrimitiveRender(id EntityID, component PrimitiveRenderComponent) bool {
	if !w.HasEntity(id) {
		return false
	}
